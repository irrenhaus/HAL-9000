...
#include "system_stm32f10x_6403_IUT.h"
#else
...
#endif
/* # 1 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
/* # 1 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\.coverage\\data//"*/
/* # 1 "<built-in>"*/
/* # 1 "<command-line>"*/
/* # 1 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
/* # 33 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
...
# 34 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c" 2
/* # 122 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
...
/* # 136 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
static void SetSysClock(void);
/* # 149 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
  static void SetSysClockTo72(void);
/* # 172 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
void SystemInit (void)
{ CODESCROLL_FUNC_BEGIN(474, (474, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable1167,1069) 


  
  CS_CMM_PROBE_NODE_STMT(242,0,0) ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR |= (uint32_t)0x00000001;
...
/* # 222 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
  SetSysClock();

CS_CMM_PROBE_NODE_STMT(243,7,1) 
 CODESCROLL_FUNC_END(474, 25, 223) } CODESCROLL_FUNC_END_RBRACE 
...
{ CODESCROLL_FUNC_BEGIN(475, (475, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable1168,1070) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable1169,243,6,0)
  ...
  CS_CMM_PROBE_NODE_STMT(243,5,1) switch (tmp)
  {
    case 0x00: CS_CMM_PROBE_C1(1071) 
      
      CS_CMM_PROBE_NODE_STMT(243,4,2) SystemCoreClock = ((uint32_t)8000000);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_475_1) ;
    case 0x04: CS_CMM_PROBE_C1(1072) 
      
      CS_CMM_PROBE_NODE_STMT(243,3,3) SystemCoreClock = ((uint32_t)25000000);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_475_1) ;
    case 0x08: CS_CMM_PROBE_C1(1073) 


      
      CS_CMM_PROBE_NODE_STMT(243,2,4) pllmull = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR & ((uint32_t)0x003C0000);
      pllsource = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR & ((uint32_t)0x00010000);
/* # 287 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
      pllmull = pllmull >> 18;

      
      CS_CMM_PROBE_NODE_STMT(243,1,5) if (pllmull != 0x0D)
      { CS_CMM_PROBE_DECL_C1(CodeScrollVariable1170,1074) 
         
         CS_CMM_PROBE_NODE_STMT(243,0,6) pllmull += 2;
      }
      else
      { CS_CMM_PROBE_DECL_C1(CodeScrollVariable1171,1075) 
        
        CS_CMM_PROBE_NODE_STMT(244,7,7) pllmull = 13 / 2;
      }

      
      CS_CMM_PROBE_NODE_STMT(244,6,8) if (pllsource == 0x00)
      { CS_CMM_PROBE_DECL_C1(CodeScrollVariable1172,1076) 

        
        CS_CMM_PROBE_NODE_STMT(244,5,9) SystemCoreClock = (((uint32_t)8000000) >> 1) * pllmull;
      }
      else
      {
        ...
        CS_CMM_PROBE_NODE_STMT(244,4,10) prediv1source = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR2 & ((uint32_t)0x00010000);
        prediv1factor = (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR2 & ((uint32_t)0x0000000F)) + 1;

        
        CS_CMM_PROBE_NODE_STMT(244,3,11) if (prediv1source == 0)
        { CS_CMM_PROBE_DECL_C1(CodeScrollVariable1173,1077) 

          
          CS_CMM_PROBE_NODE_STMT(244,2,12) SystemCoreClock = (((uint32_t)25000000) / prediv1factor) * pllmull;
        }
        else
        { CS_CMM_PROBE_DECL_C1(CodeScrollVariable1174,1078) 


          
          CS_CMM_PROBE_NODE_STMT(244,1,13) prediv2factor = ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR2 & ((uint32_t)0x000000F0)) >> 4) + 1;
    ...
    default: CS_CMM_PROBE_C1(1079) 
      
      CS_CMM_PROBE_NODE_STMT(244,0,14) SystemCoreClock = ((uint32_t)8000000);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_475_1) ;
  } CS_CMM_LABEL(cs_cmm_switch_end_475_1) 



  
  CS_CMM_PROBE_NODE_STMT(245,7,15) tmp = AHBPrescTable[((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR & ((uint32_t)0x000000F0)) >> 4)];

  SystemCoreClock >>= tmp;

CS_CMM_PROBE_NODE_STMT(245,6,16) 
 CODESCROLL_FUNC_END(475, 25, 337) } CODESCROLL_FUNC_END_RBRACE 
...
static void SetSysClock(void)
{ CODESCROLL_FUNC_BEGIN(476, (476, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable1175,1080) 
/* # 357 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
  
  CS_CMM_PROBE_NODE_STMT(245,5,0) SetSysClockTo72();





CS_CMM_PROBE_NODE_STMT(245,4,1) 
 CODESCROLL_FUNC_END(476, 25, 362) } CODESCROLL_FUNC_END_RBRACE 
/* # 912 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
static void SetSysClockTo72(void)
{ CODESCROLL_FUNC_BEGIN(477, (477, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable1176,1081) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable1177,245,3,0)
  ...
  CS_CMM_do(cs_cmm_do_start_477_2) 
  {CS_CMM_PROBE_NODE_DECL(CodeScrollVariable1178,245,2,1)

  
    HSEStatus = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR & ((uint32_t)0x00020000);
    StartUpCounter++;
  } CS_CMM_while_CX(55, 56, cs_cmm_do_start_477_2, cs_cmm_do_cond_477_2, cs_cmm_do_end_477_2, ( CS_CMM_PROBE_NODE_EXPR(245,1,2) CS_MCDC_477_0((HSEStatus == 0), (StartUpCounter != ((uint16_t)0x0500)), 94)));

  
  CS_CMM_PROBE_NODE_STMT(245,0,3) if ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR & ((uint32_t)0x00020000)) != RESET)
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable1179,1082) 
    
    CS_CMM_PROBE_NODE_STMT(246,7,4) HSEStatus = (uint32_t)0x01;
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable1180,1083) 
    
    CS_CMM_PROBE_NODE_STMT(246,6,5) HSEStatus = (uint32_t)0x00;
  }

  
  CS_CMM_PROBE_NODE_STMT(246,5,6) if (HSEStatus == (uint32_t)0x01)
  {

    
    CS_CMM_PROBE_NODE_STMT(246,4,7) ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->ACR |= ((uint8_t)0x10);
    ...
    while( CS_CMM_PROBE_NODE_EXPR(246,3,8) (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR & ((uint32_t)0x08000000)) == 0)
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable1181,1084) 
    
    CS_CMM_PROBE_NODE_STMT(246,2,9) } CS_CMM_PROBE_C1(1085) CS_CMM_LABEL(cs_cmm_while_end_477_8) 



    
    CS_CMM_PROBE_NODE_STMT(246,1,10) ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR &= (uint32_t)~(((uint32_t)0x00020000) | ((uint32_t)0x00010000) | ((uint32_t)0x003C0000));
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR |= (uint32_t)(((uint32_t)0x00000000) | ((uint32_t)0x00010000) |
                            ((uint32_t)0x001C0000));
/* # 985 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\system_stm32f10x.c"*/
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR |= ((uint32_t)0x01000000);


    while( CS_CMM_PROBE_NODE_EXPR(246,0,11) (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR & ((uint32_t)0x02000000)) == 0)
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable1182,1086) 
    
    CS_CMM_PROBE_NODE_STMT(247,7,12) } CS_CMM_PROBE_C1(1087) CS_CMM_LABEL(cs_cmm_while_end_477_11) 


    
    CS_CMM_PROBE_NODE_STMT(247,6,13) ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR &= (uint32_t)((uint32_t)~(((uint32_t)0x00000003)));
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR |= (uint32_t)((uint32_t)0x00000002);


    while ( CS_CMM_PROBE_NODE_EXPR(247,5,14) (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR & (uint32_t)((uint32_t)0x0000000C)) != (uint32_t)0x08)
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable1183,1088) 
    
    CS_CMM_PROBE_NODE_STMT(247,4,15) } CS_CMM_PROBE_C1(1089) CS_CMM_LABEL(cs_cmm_while_end_477_14) 
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable1184,1090) 

  
  CS_CMM_PROBE_NODE_STMT(247,3,16) }

CS_CMM_PROBE_NODE_STMT(247,2,17) 
 CODESCROLL_FUNC_END(477, 25, 1005) } CODESCROLL_FUNC_END_RBRACE 
