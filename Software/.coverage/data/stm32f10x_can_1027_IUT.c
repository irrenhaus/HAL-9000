...
#include "stm32f10x_can_1027_IUT.h"
#else
...
#endif
/* # 1 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
/* # 1 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\.coverage\\data//"*/
/* # 1 "<built-in>"*/
/* # 1 "<command-line>"*/
/* # 1 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
/* # 22 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
...
/* # 31 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\inc/stm32f10x_can.h"*/
...
# 32 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\inc/stm32f10x_can.h" 2
...
# 23 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c" 2
/* # 128 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
static ITStatus CheckITStatus(uint32_t CAN_Reg, uint32_t It_Bit);
/* # 143 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
void CAN_DeInit(CAN_TypeDef* CANx)
{ CODESCROLL_FUNC_BEGIN(53, (53, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable126,102) 

  
  CS_CMM_PROBE_NODE_STMT(23,7,0) ((void)0);

  
  CS_CMM_PROBE_NODE_STMT(23,6,1) if (CANx == ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable127,103) 

    
    CS_CMM_PROBE_NODE_STMT(23,5,2) RCC_APB1PeriphResetCmd(((uint32_t)0x02000000), ENABLE);

    RCC_APB1PeriphResetCmd(((uint32_t)0x02000000), DISABLE);
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable128,104) 

    
    CS_CMM_PROBE_NODE_STMT(23,4,3) RCC_APB1PeriphResetCmd(((uint32_t)0x04000000), ENABLE);

    RCC_APB1PeriphResetCmd(((uint32_t)0x04000000), DISABLE);
  }

CS_CMM_PROBE_NODE_STMT(23,3,4) 
 CODESCROLL_FUNC_END(53, 4, 162) } CODESCROLL_FUNC_END_RBRACE 
/* # 173 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
uint8_t CAN_Init(CAN_TypeDef* CANx, CAN_InitTypeDef* CAN_InitStruct)
{ CODESCROLL_FUNC_BEGIN(54, (54, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable129,105) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable130,23,2,0)
  ...
  CANx->MCR &= ~((uint32_t)0x00000002);


  CANx->MCR |= ((uint32_t)0x00000001) ;


  while ( CS_CMM_PROBE_NODE_EXPR(23,1,1) CS_MCDC_54_0(((CANx->MSR & ((uint32_t)0x00000001)) != ((uint32_t)0x00000001)), (wait_ack != ((uint32_t)0x0000FFFF)), 3))
  { CS_CMM_PROBE_DECL_CX(CodeScrollVariable131,2) 
    
    CS_CMM_PROBE_NODE_STMT(23,0,2) wait_ack++;
  } CS_CMM_PROBE_CX(3) CS_CMM_LABEL(cs_cmm_while_end_54_1) 


  
  CS_CMM_PROBE_NODE_STMT(24,7,3) if ((CANx->MSR & ((uint32_t)0x00000001)) != ((uint32_t)0x00000001))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable132,106) 
    
    CS_CMM_PROBE_NODE_STMT(24,6,4) InitStatus = ((uint8_t)0x00);
  }
  else
  {

    
    CS_CMM_PROBE_NODE_STMT(24,5,5) if (CAN_InitStruct->CAN_TTCM == ENABLE)
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable133,107) 
      
      CS_CMM_PROBE_NODE_STMT(24,4,6) CANx->MCR |= ((uint32_t)0x00000080);
    }
    else
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable134,108) 
      
      CS_CMM_PROBE_NODE_STMT(24,3,7) CANx->MCR &= ~((uint32_t)0x00000080);
    }


    
    CS_CMM_PROBE_NODE_STMT(24,2,8) if (CAN_InitStruct->CAN_ABOM == ENABLE)
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable135,109) 
      
      CS_CMM_PROBE_NODE_STMT(24,1,9) CANx->MCR |= ((uint32_t)0x00000040);
    }
    else
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable136,110) 
      
      CS_CMM_PROBE_NODE_STMT(24,0,10) CANx->MCR &= ~((uint32_t)0x00000040);
    }


    
    CS_CMM_PROBE_NODE_STMT(25,7,11) if (CAN_InitStruct->CAN_AWUM == ENABLE)
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable137,111) 
      
      CS_CMM_PROBE_NODE_STMT(25,6,12) CANx->MCR |= ((uint32_t)0x00000020);
    }
    else
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable138,112) 
      
      CS_CMM_PROBE_NODE_STMT(25,5,13) CANx->MCR &= ~((uint32_t)0x00000020);
    }


    
    CS_CMM_PROBE_NODE_STMT(25,4,14) if (CAN_InitStruct->CAN_NART == ENABLE)
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable139,113) 
      
      CS_CMM_PROBE_NODE_STMT(25,3,15) CANx->MCR |= ((uint32_t)0x00000010);
    }
    else
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable140,114) 
      
      CS_CMM_PROBE_NODE_STMT(25,2,16) CANx->MCR &= ~((uint32_t)0x00000010);
    }


    
    CS_CMM_PROBE_NODE_STMT(25,1,17) if (CAN_InitStruct->CAN_RFLM == ENABLE)
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable141,115) 
      
      CS_CMM_PROBE_NODE_STMT(25,0,18) CANx->MCR |= ((uint32_t)0x00000008);
    }
    else
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable142,116) 
      
      CS_CMM_PROBE_NODE_STMT(26,7,19) CANx->MCR &= ~((uint32_t)0x00000008);
    }


    
    CS_CMM_PROBE_NODE_STMT(26,6,20) if (CAN_InitStruct->CAN_TXFP == ENABLE)
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable143,117) 
      
      CS_CMM_PROBE_NODE_STMT(26,5,21) CANx->MCR |= ((uint32_t)0x00000004);
    }
    else
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable144,118) 
      
      CS_CMM_PROBE_NODE_STMT(26,4,22) CANx->MCR &= ~((uint32_t)0x00000004);
    }


    
    CS_CMM_PROBE_NODE_STMT(26,3,23) CANx->BTR = (uint32_t)((uint32_t)CAN_InitStruct->CAN_Mode << 30) | ((uint32_t)CAN_InitStruct->CAN_SJW << 24) |
   ...
   while ( CS_CMM_PROBE_NODE_EXPR(26,2,24) CS_MCDC_54_8(((CANx->MSR & ((uint32_t)0x00000001)) == ((uint32_t)0x00000001)), (wait_ack != ((uint32_t)0x0000FFFF)), 6))
   { CS_CMM_PROBE_DECL_CX(CodeScrollVariable145,4) 
     
     CS_CMM_PROBE_NODE_STMT(26,1,25) wait_ack++;
   } CS_CMM_PROBE_CX(5) CS_CMM_LABEL(cs_cmm_while_end_54_24) 


    
    CS_CMM_PROBE_NODE_STMT(26,0,26) if ((CANx->MSR & ((uint32_t)0x00000001)) == ((uint32_t)0x00000001))
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable146,119) 
      
      CS_CMM_PROBE_NODE_STMT(27,7,27) InitStatus = ((uint8_t)0x00);
    }
    else
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable147,120) 
      
      CS_CMM_PROBE_NODE_STMT(27,6,28) InitStatus = ((uint8_t)0x01) ;
    }
  }


  
  CS_CMM_PROBE_NODE_STMT(27,5,29) 
   CODESCROLL_FUNC_END(54, 4, 298) return InitStatus;
} CODESCROLL_FUNC_END_RBRACE 
/* # 308 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
void CAN_FilterInit(CAN_FilterInitTypeDef* CAN_FilterInitStruct)
{ CODESCROLL_FUNC_BEGIN(55, (55, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable148,121) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable149,27,4,0)
  ...
  CS_CMM_PROBE_NODE_STMT(27,3,1) if (CAN_FilterInitStruct->CAN_FilterScale == ((uint8_t)0x00))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable150,122) 

    
    CS_CMM_PROBE_NODE_STMT(27,2,2) ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FS1R &= ~(uint32_t)filter_number_bit_pos;
  ...
  } CS_CMM_ELSE_PROBE_C1(123) 

  
  CS_CMM_PROBE_NODE_STMT(27,1,3) if (CAN_FilterInitStruct->CAN_FilterScale == ((uint8_t)0x01))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable151,124) 

    
    CS_CMM_PROBE_NODE_STMT(27,0,4) ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FS1R |= filter_number_bit_pos;
  ...
  } CS_CMM_ELSE_PROBE_C1(125) 


  
  CS_CMM_PROBE_NODE_STMT(28,7,5) if (CAN_FilterInitStruct->CAN_FilterMode == ((uint8_t)0x00))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable152,126) 

    
    CS_CMM_PROBE_NODE_STMT(28,6,6) ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FM1R &= ~(uint32_t)filter_number_bit_pos;
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable153,127) 

    
    CS_CMM_PROBE_NODE_STMT(28,5,7) ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FM1R |= (uint32_t)filter_number_bit_pos;
  }


  
  CS_CMM_PROBE_NODE_STMT(28,4,8) if (CAN_FilterInitStruct->CAN_FilterFIFOAssignment == ((uint8_t)0x00))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable154,128) 

    
    CS_CMM_PROBE_NODE_STMT(28,3,9) ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FFA1R &= ~(uint32_t)filter_number_bit_pos;
  } CS_CMM_ELSE_PROBE_C1(129) 

  
  CS_CMM_PROBE_NODE_STMT(28,2,10) if (CAN_FilterInitStruct->CAN_FilterFIFOAssignment == ((uint8_t)0x01))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable155,130) 

    
    CS_CMM_PROBE_NODE_STMT(28,1,11) ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FFA1R |= (uint32_t)filter_number_bit_pos;
  } CS_CMM_ELSE_PROBE_C1(131) 


  
  CS_CMM_PROBE_NODE_STMT(28,0,12) if (CAN_FilterInitStruct->CAN_FilterActivation == ENABLE)
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable156,132) 
    
    CS_CMM_PROBE_NODE_STMT(29,7,13) ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FA1R |= filter_number_bit_pos;
  } CS_CMM_ELSE_PROBE_C1(133) 


  
  CS_CMM_PROBE_NODE_STMT(29,6,14) ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FMR &= ~((uint32_t)0x00000001);

CS_CMM_PROBE_NODE_STMT(29,5,15) 
 CODESCROLL_FUNC_END(55, 4, 392) } CODESCROLL_FUNC_END_RBRACE 
...
void CAN_StructInit(CAN_InitTypeDef* CAN_InitStruct)
{ CODESCROLL_FUNC_BEGIN(56, (56, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable157,134) 


  
  CS_CMM_PROBE_NODE_STMT(29,4,0) CAN_InitStruct->CAN_TTCM = DISABLE;
...
CS_CMM_PROBE_NODE_STMT(29,3,1) 
 CODESCROLL_FUNC_END(56, 4, 425) } CODESCROLL_FUNC_END_RBRACE 
...
void CAN_SlaveStartBank(uint8_t CAN_BankNumber)
{ CODESCROLL_FUNC_BEGIN(57, (57, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable158,135) 

  
  CS_CMM_PROBE_NODE_STMT(29,2,0) ((void)0);
...
CS_CMM_PROBE_NODE_STMT(29,1,1) 
 CODESCROLL_FUNC_END(57, 4, 444) } CODESCROLL_FUNC_END_RBRACE 
/* # 459 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
void CAN_ITConfig(CAN_TypeDef* CANx, uint32_t CAN_IT, FunctionalState NewState)
{ CODESCROLL_FUNC_BEGIN(58, (58, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable159,136) 

  
  CS_CMM_PROBE_NODE_STMT(29,0,0) ((void)0);
  ((void)0);
  ((void)0);

  
  CS_CMM_PROBE_NODE_STMT(30,7,1) if (NewState != DISABLE)
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable160,137) 

    
    CS_CMM_PROBE_NODE_STMT(30,6,2) CANx->IER |= CAN_IT;
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable161,138) 

    
    CS_CMM_PROBE_NODE_STMT(30,5,3) CANx->IER &= ~CAN_IT;
  }

CS_CMM_PROBE_NODE_STMT(30,4,4) 
 CODESCROLL_FUNC_END(58, 4, 476) } CODESCROLL_FUNC_END_RBRACE 
/* # 486 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
uint8_t CAN_Transmit(CAN_TypeDef* CANx, CanTxMsg* TxMessage)
{ CODESCROLL_FUNC_BEGIN(59, (59, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable162,139) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable163,30,3,0)
  ...
  CS_CMM_PROBE_NODE_STMT(30,2,1) if ((CANx->TSR&((uint32_t)0x04000000)) == ((uint32_t)0x04000000))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable164,140) 
    
    CS_CMM_PROBE_NODE_STMT(30,1,2) transmit_mailbox = 0;
  }
  else { 
  CS_CMM_PROBE_NODE_STMT(30,0,3) if ((CANx->TSR&((uint32_t)0x08000000)) == ((uint32_t)0x08000000))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable165,141) 
    
    CS_CMM_PROBE_NODE_STMT(31,7,4) transmit_mailbox = 1;
  }
  else { 
  CS_CMM_PROBE_NODE_STMT(31,6,5) if ((CANx->TSR&((uint32_t)0x10000000)) == ((uint32_t)0x10000000))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable166,142) 
    
    CS_CMM_PROBE_NODE_STMT(31,5,6) transmit_mailbox = 2;
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable167,143) 
    
    CS_CMM_PROBE_NODE_STMT(31,4,7) transmit_mailbox = ((uint8_t)0x04);
  }
  }
  }

  
  CS_CMM_PROBE_NODE_STMT(31,3,8) if (transmit_mailbox != ((uint8_t)0x04))
  {

    
    CS_CMM_PROBE_NODE_STMT(31,2,9) CANx->sTxMailBox[transmit_mailbox].TIR &= ((uint32_t)0x00000001);
    
    CS_CMM_PROBE_NODE_STMT(31,1,10) if (TxMessage->IDE == ((uint32_t)0x00000000))
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable168,144) 
      
      CS_CMM_PROBE_NODE_STMT(31,0,11) ((void)0);
      CANx->sTxMailBox[transmit_mailbox].TIR |= ((TxMessage->StdId << 21) | TxMessage->RTR);
    }
    else
    { CS_CMM_PROBE_DECL_C1(CodeScrollVariable169,145) 
      
      CS_CMM_PROBE_NODE_STMT(32,7,12) ((void)0);
    ...
    CS_CMM_PROBE_NODE_STMT(32,6,13) TxMessage->DLC &= (uint8_t)0x0000000F;
  ...
  } CS_CMM_ELSE_PROBE_C1(146) 
  
  CS_CMM_PROBE_NODE_STMT(32,5,14) 
   CODESCROLL_FUNC_END(59, 4, 547) return transmit_mailbox;
} CODESCROLL_FUNC_END_RBRACE 
...
uint8_t CAN_TransmitStatus(CAN_TypeDef* CANx, uint8_t TransmitMailbox)
{ CODESCROLL_FUNC_BEGIN(60, (60, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable170,147) 

  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable171,32,4,0)
  ...
  CS_CMM_PROBE_NODE_STMT(32,3,1) switch (TransmitMailbox)
  {
    case (0): CS_CMM_PROBE_C1(148)  
    CS_CMM_PROBE_NODE_STMT(32,2,2) state |= (uint8_t)((CANx->TSR & ((uint32_t)0x00000001)) << 2);
      state |= (uint8_t)((CANx->TSR & ((uint32_t)0x00000002)) >> 0);
      state |= (uint8_t)((CANx->TSR & ((uint32_t)0x04000000)) >> 26);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_60_1) ;
    case (1): CS_CMM_PROBE_C1(149)  
    CS_CMM_PROBE_NODE_STMT(32,1,3) state |= (uint8_t)((CANx->TSR & ((uint32_t)0x00000100)) >> 6);
      state |= (uint8_t)((CANx->TSR & ((uint32_t)0x00000200)) >> 8);
      state |= (uint8_t)((CANx->TSR & ((uint32_t)0x08000000)) >> 27);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_60_1) ;
    case (2): CS_CMM_PROBE_C1(150)  
    CS_CMM_PROBE_NODE_STMT(32,0,4) state |= (uint8_t)((CANx->TSR & ((uint32_t)0x00010000)) >> 14);
      state |= (uint8_t)((CANx->TSR & ((uint32_t)0x00020000)) >> 16);
      state |= (uint8_t)((CANx->TSR & ((uint32_t)0x10000000)) >> 28);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_60_1) ;
    default: CS_CMM_PROBE_C1(151) 
      
      CS_CMM_PROBE_NODE_STMT(33,7,5) state = ((uint8_t)0x00);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_60_1) ;
  } CS_CMM_LABEL(cs_cmm_switch_end_60_1) 
  
  CS_CMM_PROBE_NODE_STMT(33,6,6) switch (state)
  {

    case (0x0): CS_CMM_PROBE_C1(152)  
    CS_CMM_PROBE_NODE_STMT(33,5,7) state = ((uint8_t)0x02);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_60_6) ;

    case (0x5): CS_CMM_PROBE_C1(153)  
    CS_CMM_PROBE_NODE_STMT(33,4,8) state = ((uint8_t)0x00);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_60_6) ;

    case (0x7): CS_CMM_PROBE_C1(154)  
    CS_CMM_PROBE_NODE_STMT(33,3,9) state = ((uint8_t)0x01);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_60_6) ;
    default: CS_CMM_PROBE_C1(155) 
      
      CS_CMM_PROBE_NODE_STMT(33,2,10) state = ((uint8_t)0x00);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_60_6) ;
  } CS_CMM_LABEL(cs_cmm_switch_end_60_6) 
  
  CS_CMM_PROBE_NODE_STMT(33,1,11) 
   CODESCROLL_FUNC_END(60, 4, 596) return state;
} CODESCROLL_FUNC_END_RBRACE 
...
void CAN_CancelTransmit(CAN_TypeDef* CANx, uint8_t Mailbox)
{ CODESCROLL_FUNC_BEGIN(61, (61, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable172,156) 

  
  CS_CMM_PROBE_NODE_STMT(33,0,0) ((void)0);
  ((void)0);

  
  CS_CMM_PROBE_NODE_STMT(34,7,1) switch (Mailbox)
  {
    case (0): CS_CMM_PROBE_C1(157)  
    CS_CMM_PROBE_NODE_STMT(34,6,2) CANx->TSR |= ((uint32_t)0x00000080);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_61_1) ;
    case (1): CS_CMM_PROBE_C1(158)  
    CS_CMM_PROBE_NODE_STMT(34,5,3) CANx->TSR |= ((uint32_t)0x00008000);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_61_1) ;
    case (2): CS_CMM_PROBE_C1(159)  
    CS_CMM_PROBE_NODE_STMT(34,4,4) CANx->TSR |= ((uint32_t)0x00800000);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_61_1) ;
    default: CS_CMM_PROBE_C1(160) 
      
      CS_CMM_PROBE_NODE_STMT(34,3,5) CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_61_1) ;
  } CS_CMM_LABEL(cs_cmm_switch_end_61_1) 

CS_CMM_PROBE_NODE_STMT(34,2,6) 
 CODESCROLL_FUNC_END(61, 4, 622) } CODESCROLL_FUNC_END_RBRACE 
...
void CAN_FIFORelease(CAN_TypeDef* CANx, uint8_t FIFONumber)
{ CODESCROLL_FUNC_BEGIN(62, (62, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable173,161) 

  
  CS_CMM_PROBE_NODE_STMT(34,1,0) ((void)0);
  ((void)0);

  
  CS_CMM_PROBE_NODE_STMT(34,0,1) if (FIFONumber == ((uint8_t)0x00))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable174,162) 
    
    CS_CMM_PROBE_NODE_STMT(35,7,2) CANx->RF0R = ((uint32_t)0x00000020);
  }

  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable175,163) 
    
    CS_CMM_PROBE_NODE_STMT(35,6,3) CANx->RF1R = ((uint32_t)0x00000020);
  }

CS_CMM_PROBE_NODE_STMT(35,5,4) 
 CODESCROLL_FUNC_END(62, 4, 645) } CODESCROLL_FUNC_END_RBRACE 
...
uint8_t CAN_MessagePending(CAN_TypeDef* CANx, uint8_t FIFONumber)
{ CODESCROLL_FUNC_BEGIN(63, (63, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable176,164) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable177,35,4,0)
  ...
  CS_CMM_PROBE_NODE_STMT(35,3,1) if (FIFONumber == ((uint8_t)0x00))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable178,165) 
    
    CS_CMM_PROBE_NODE_STMT(35,2,2) message_pending = (uint8_t)(CANx->RF0R&(uint32_t)0x03);
  }
  else { 
  CS_CMM_PROBE_NODE_STMT(35,1,3) if (FIFONumber == ((uint8_t)0x01))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable179,166) 
    
    CS_CMM_PROBE_NODE_STMT(35,0,4) message_pending = (uint8_t)(CANx->RF1R&(uint32_t)0x03);
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable180,167) 
    
    CS_CMM_PROBE_NODE_STMT(36,7,5) message_pending = 0;
  }
  }
  
  CS_CMM_PROBE_NODE_STMT(36,6,6) 
   CODESCROLL_FUNC_END(63, 4, 671) return message_pending;
} CODESCROLL_FUNC_END_RBRACE 
/* # 682 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
void CAN_Receive(CAN_TypeDef* CANx, uint8_t FIFONumber, CanRxMsg* RxMessage)
{ CODESCROLL_FUNC_BEGIN(64, (64, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable181,168) 

  
  CS_CMM_PROBE_NODE_STMT(36,5,0) ((void)0);
  ((void)0);

  RxMessage->IDE = (uint8_t)0x04 & CANx->sFIFOMailBox[FIFONumber].RIR;
  
  CS_CMM_PROBE_NODE_STMT(36,4,1) if (RxMessage->IDE == ((uint32_t)0x00000000))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable182,169) 
    
    CS_CMM_PROBE_NODE_STMT(36,3,2) RxMessage->StdId = (uint32_t)0x000007FF & (CANx->sFIFOMailBox[FIFONumber].RIR >> 21);
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable183,170) 
    
    CS_CMM_PROBE_NODE_STMT(36,2,3) RxMessage->ExtId = (uint32_t)0x1FFFFFFF & (CANx->sFIFOMailBox[FIFONumber].RIR >> 3);
  }

  
  CS_CMM_PROBE_NODE_STMT(36,1,4) RxMessage->RTR = (uint8_t)0x02 & CANx->sFIFOMailBox[FIFONumber].RIR;
...
CS_CMM_PROBE_NODE_STMT(36,0,5) 
 CODESCROLL_FUNC_END(64, 4, 714) } CODESCROLL_FUNC_END_RBRACE 
/* # 723 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
void CAN_DBGFreeze(CAN_TypeDef* CANx, FunctionalState NewState)
{ CODESCROLL_FUNC_BEGIN(65, (65, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable184,171) 

  
  CS_CMM_PROBE_NODE_STMT(37,7,0) ((void)0);
  ((void)0);

  
  CS_CMM_PROBE_NODE_STMT(37,6,1) if (NewState != DISABLE)
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable185,172) 

    
    CS_CMM_PROBE_NODE_STMT(37,5,2) CANx->MCR |= ((uint32_t)0x00010000);
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable186,173) 

    
    CS_CMM_PROBE_NODE_STMT(37,4,3) CANx->MCR &= ~((uint32_t)0x00010000);
  }

CS_CMM_PROBE_NODE_STMT(37,3,4) 
 CODESCROLL_FUNC_END(65, 4, 739) } CODESCROLL_FUNC_END_RBRACE 
...
uint8_t CAN_Sleep(CAN_TypeDef* CANx)
{ CODESCROLL_FUNC_BEGIN(66, (66, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable187,174) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable188,37,2,0)
  ...
  ((void)0);
   ...
   CANx->MCR = (((CANx->MCR) & (uint32_t)(~((uint32_t)0x00000001))) | ((uint32_t)0x00000002));


  
  CS_CMM_PROBE_NODE_STMT(37,1,1) if ((CANx->MSR & (((uint16_t)0x0002)|((uint16_t)0x0001))) == ((uint16_t)0x0002))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable189,175) 

    
    CS_CMM_PROBE_NODE_STMT(37,0,2) sleepstatus = ((uint8_t)0x01);
  } CS_CMM_ELSE_PROBE_C1(176) 

   
   CS_CMM_PROBE_NODE_STMT(38,7,3) 
    CODESCROLL_FUNC_END(66, 4, 763) return (uint8_t)sleepstatus;
} CODESCROLL_FUNC_END_RBRACE 
...
uint8_t CAN_WakeUp(CAN_TypeDef* CANx)
{ CODESCROLL_FUNC_BEGIN(67, (67, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable190,177) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable191,38,6,0)
  ...
  while( CS_CMM_PROBE_NODE_EXPR(38,5,1) CS_MCDC_67_0(((CANx->MSR & ((uint16_t)0x0002)) == ((uint16_t)0x0002)), (wait_slak!=0x00), 9))
  { CS_CMM_PROBE_DECL_CX(CodeScrollVariable192,6) 
   
   CS_CMM_PROBE_NODE_STMT(38,4,2) wait_slak--;
  } CS_CMM_PROBE_CX(7) CS_CMM_LABEL(cs_cmm_while_end_67_1) 
  
  CS_CMM_PROBE_NODE_STMT(38,3,3) if((CANx->MSR & ((uint16_t)0x0002)) != ((uint16_t)0x0002))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable193,178) 

    
    CS_CMM_PROBE_NODE_STMT(38,2,4) wakeupstatus = ((uint8_t)0x01);
  } CS_CMM_ELSE_PROBE_C1(179) 

  
  CS_CMM_PROBE_NODE_STMT(38,1,5) 
   CODESCROLL_FUNC_END(67, 4, 793) return (uint8_t)wakeupstatus;
} CODESCROLL_FUNC_END_RBRACE 
/* # 803 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
FlagStatus CAN_GetFlagStatus(CAN_TypeDef* CANx, uint32_t CAN_FLAG)
{ CODESCROLL_FUNC_BEGIN(68, (68, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable194,180) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable195,38,0,0)
  ...
  CS_CMM_PROBE_NODE_STMT(39,7,1) if ((CANx->ESR & CAN_FLAG) != (uint32_t)RESET)
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable196,181) 

    
    CS_CMM_PROBE_NODE_STMT(39,6,2) bitstatus = SET;
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable197,182) 

    
    CS_CMM_PROBE_NODE_STMT(39,5,3) bitstatus = RESET;
  }

  
  CS_CMM_PROBE_NODE_STMT(39,4,4) 
   CODESCROLL_FUNC_END(68, 4, 821) return bitstatus;
} CODESCROLL_FUNC_END_RBRACE 
...
void CAN_ClearFlag(CAN_TypeDef* CANx, uint32_t CAN_FLAG)
{ CODESCROLL_FUNC_BEGIN(69, (69, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable198,183) 

  
  CS_CMM_PROBE_NODE_STMT(39,3,0) ((void)0);
  ((void)0);

  CANx->ESR &= ~CAN_FLAG;

CS_CMM_PROBE_NODE_STMT(39,2,1) 
 CODESCROLL_FUNC_END(69, 4, 837) } CODESCROLL_FUNC_END_RBRACE 
/* # 849 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\stm32f10x_can.c"*/
ITStatus CAN_GetITStatus(CAN_TypeDef* CANx, uint32_t CAN_IT)
{ CODESCROLL_FUNC_BEGIN(70, (70, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable199,184) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable200,39,1,0)
  ...
  CS_CMM_PROBE_NODE_STMT(39,0,1) switch (CAN_IT)
  {
    case ((uint32_t)0x00000005): CS_CMM_PROBE_C1(185) 
      
      CS_CMM_PROBE_NODE_STMT(40,7,2) pendingbitstatus = CheckITStatus(CANx->TSR, ((uint32_t)0x00000001));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    case ((uint32_t)0x00000006): CS_CMM_PROBE_C1(186) 
      
      CS_CMM_PROBE_NODE_STMT(40,6,3) pendingbitstatus = CheckITStatus(CANx->TSR, ((uint32_t)0x00000100));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    case ((uint32_t)0x00000007): CS_CMM_PROBE_C1(187) 
      
      CS_CMM_PROBE_NODE_STMT(40,5,4) pendingbitstatus = CheckITStatus(CANx->TSR, ((uint32_t)0x00010000));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    case ((uint32_t)0x00000004): CS_CMM_PROBE_C1(188) 
      
      CS_CMM_PROBE_NODE_STMT(40,4,5) pendingbitstatus = CheckITStatus(CANx->RF0R, ((uint32_t)0x00000008));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    case ((uint32_t)0x00000008): CS_CMM_PROBE_C1(189) 
      
      CS_CMM_PROBE_NODE_STMT(40,3,6) pendingbitstatus = CheckITStatus(CANx->RF0R, ((uint32_t)0x00000010));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    case ((uint32_t)0x00000020): CS_CMM_PROBE_C1(190) 
      
      CS_CMM_PROBE_NODE_STMT(40,2,7) pendingbitstatus = CheckITStatus(CANx->RF1R, ((uint32_t)0x00000008));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    case ((uint32_t)0x00000040): CS_CMM_PROBE_C1(191) 
      
      CS_CMM_PROBE_NODE_STMT(40,1,8) pendingbitstatus = CheckITStatus(CANx->RF1R, ((uint32_t)0x00000010));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    case ((uint32_t)0x00000100): CS_CMM_PROBE_C1(192) 
      
      CS_CMM_PROBE_NODE_STMT(40,0,9) pendingbitstatus = CheckITStatus(CANx->ESR, ((uint32_t)0x00000001));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    case ((uint32_t)0x00000200): CS_CMM_PROBE_C1(193) 
      
      CS_CMM_PROBE_NODE_STMT(41,7,10) pendingbitstatus = CheckITStatus(CANx->ESR, ((uint32_t)0x00000002));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    case ((uint32_t)0x00000400): CS_CMM_PROBE_C1(194) 
      
      CS_CMM_PROBE_NODE_STMT(41,6,11) pendingbitstatus = CheckITStatus(CANx->ESR, ((uint32_t)0x00000004));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    case ((uint32_t)0x00020000): CS_CMM_PROBE_C1(195) 
      
      CS_CMM_PROBE_NODE_STMT(41,5,12) pendingbitstatus = CheckITStatus(CANx->MSR, ((uint32_t)0x00000010));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    case ((uint32_t)0x00010000): CS_CMM_PROBE_C1(196) 
      
      CS_CMM_PROBE_NODE_STMT(41,4,13) pendingbitstatus = CheckITStatus(CANx->MSR, ((uint32_t)0x00000008));
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
    default : CS_CMM_PROBE_C1(197) 
      
      CS_CMM_PROBE_NODE_STMT(41,3,14) pendingbitstatus = RESET;
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_70_1) ;
  } CS_CMM_LABEL(cs_cmm_switch_end_70_1) 

  
  CS_CMM_PROBE_NODE_STMT(41,2,15) 
   CODESCROLL_FUNC_END(70, 4, 898) return pendingbitstatus;
} CODESCROLL_FUNC_END_RBRACE 
...
void CAN_ClearITPendingBit(CAN_TypeDef* CANx, uint32_t CAN_IT)
{ CODESCROLL_FUNC_BEGIN(71, (71, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable201,198) 

  
  CS_CMM_PROBE_NODE_STMT(41,1,0) ((void)0);
  ((void)0);
  
  CS_CMM_PROBE_NODE_STMT(41,0,1) switch (CAN_IT)
  {
    case ((uint32_t)0x00000005): CS_CMM_PROBE_C1(199) 
      
      CS_CMM_PROBE_NODE_STMT(42,7,2) CANx->TSR = ((uint32_t)0x00000001);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    case ((uint32_t)0x00000006): CS_CMM_PROBE_C1(200) 
      
      CS_CMM_PROBE_NODE_STMT(42,6,3) CANx->TSR = ((uint32_t)0x00000100);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    case ((uint32_t)0x00000007): CS_CMM_PROBE_C1(201) 
      
      CS_CMM_PROBE_NODE_STMT(42,5,4) CANx->TSR = ((uint32_t)0x00010000);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    case ((uint32_t)0x00000004): CS_CMM_PROBE_C1(202) 
      
      CS_CMM_PROBE_NODE_STMT(42,4,5) CANx->RF0R = ((uint32_t)0x00000008);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    case ((uint32_t)0x00000008): CS_CMM_PROBE_C1(203) 
      
      CS_CMM_PROBE_NODE_STMT(42,3,6) CANx->RF0R = ((uint32_t)0x00000010);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    case ((uint32_t)0x00000020): CS_CMM_PROBE_C1(204) 
      
      CS_CMM_PROBE_NODE_STMT(42,2,7) CANx->RF1R = ((uint32_t)0x00000008);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    case ((uint32_t)0x00000040): CS_CMM_PROBE_C1(205) 
      
      CS_CMM_PROBE_NODE_STMT(42,1,8) CANx->RF1R = ((uint32_t)0x00000010);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    case ((uint32_t)0x00000100): CS_CMM_PROBE_C1(206) 
      
      CS_CMM_PROBE_NODE_STMT(42,0,9) CANx->ESR &= ~ ((uint32_t)0x00000001);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    case ((uint32_t)0x00000200): CS_CMM_PROBE_C1(207) 
      
      CS_CMM_PROBE_NODE_STMT(43,7,10) CANx->ESR &= ~ ((uint32_t)0x00000002);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    case ((uint32_t)0x00000400): CS_CMM_PROBE_C1(208) 
      
      CS_CMM_PROBE_NODE_STMT(43,6,11) CANx->ESR &= ~ ((uint32_t)0x00000004);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    case ((uint32_t)0x00010000): CS_CMM_PROBE_C1(209) 
      
      CS_CMM_PROBE_NODE_STMT(43,5,12) CANx->MSR = ((uint32_t)0x00000008);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    case ((uint32_t)0x00020000): CS_CMM_PROBE_C1(210) 
      
      CS_CMM_PROBE_NODE_STMT(43,4,13) CANx->MSR = ((uint32_t)0x00000010);
      CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
    default : CS_CMM_PROBE_C1(211) 
      
      CS_CMM_PROBE_NODE_STMT(43,3,14) CS_CMM_break CS_CMM_GOTO_LABEL_SEMICOLON(cs_cmm_switch_end_71_1) ;
  } CS_CMM_LABEL(cs_cmm_switch_end_71_1) 

CS_CMM_PROBE_NODE_STMT(43,2,15) 
 CODESCROLL_FUNC_END(71, 4, 953) } CODESCROLL_FUNC_END_RBRACE 
...
static ITStatus CheckITStatus(uint32_t CAN_Reg, uint32_t It_Bit)
{ CODESCROLL_FUNC_BEGIN(72, (72, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable202,212) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable203,43,1,0)

  ITStatus pendingbitstatus = RESET;

  
  CS_CMM_PROBE_NODE_STMT(43,0,1) if ((CAN_Reg & It_Bit) != (uint32_t)RESET)
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable204,213) 

    
    CS_CMM_PROBE_NODE_STMT(44,7,2) pendingbitstatus = SET;
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable205,214) 

    
    CS_CMM_PROBE_NODE_STMT(44,6,3) pendingbitstatus = RESET;
  }
  
  CS_CMM_PROBE_NODE_STMT(44,5,4) 
   CODESCROLL_FUNC_END(72, 4, 975) return pendingbitstatus;
} CODESCROLL_FUNC_END_RBRACE 
