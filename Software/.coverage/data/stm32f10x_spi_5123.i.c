...
void I2S_Init(SPI_TypeDef* SPIx, I2S_InitTypeDef* I2S_InitStruct)
{
  ...
  else
  {
    ...
    if((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR2 & tmp) != 0)
    {

      tmp = (uint32_t)((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR2 & ((uint32_t)(0x0000F000))) >> 12);
      ...
      sourceclock = (uint32_t)(((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR2 & ((uint32_t)(0x000000F0))) >> 4) + 1);
