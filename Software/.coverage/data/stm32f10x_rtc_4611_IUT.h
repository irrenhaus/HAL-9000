...
#define CS_MCDC_291_0(C1, C2, n) \
  (C1 ? \
    (C2 ? (CS_CMM_MCDC_CX(n+0) 1) : (CS_CMM_MCDC_CX(n+1) 0)) : (CS_CMM_MCDC_CX(n+2) 0))
#else /* !CODESCROLL_MCDC_EVALUATION && !CODESCROLL_MEM_ENABLE */
#define CS_MCDC_291_0(cs_cmm_C1, cs_cmm_C2, cs_cmm_n)  CS_MCDC_291_0_ORG
#endif /* CODESCROLL_MCDC_EVALUATION || CODESCROLL_MEM_ENABLE */
/* End of extern declarations of origins */

#define CS_MCDC_291_0_ORG	 ((((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CRH & RTC_IT) != (uint16_t)RESET) && (bitstatus != (uint16_t)RESET)
