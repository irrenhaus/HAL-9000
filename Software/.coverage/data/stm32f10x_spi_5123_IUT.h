...
#define CS_MCDC_325_4(C1, C2, n) \
  (C1 ? \
    (C2 ? (CS_CMM_MCDC_CX(n+0) 1) : (CS_CMM_MCDC_CX(n+1) 0)) : (CS_CMM_MCDC_CX(n+2) 0))
#else /* !CODESCROLL_MCDC_EVALUATION && !CODESCROLL_MEM_ENABLE */
#define CS_MCDC_325_4(cs_cmm_C1, cs_cmm_C2, cs_cmm_n)  CS_MCDC_325_4_ORG
#endif /* CODESCROLL_MCDC_EVALUATION || CODESCROLL_MEM_ENABLE */
#if defined CODESCROLL_MCDC_EVALUATION || defined CODESCROLL_MEM_ENABLE
#define CS_MCDC_325_7(C1, C2, n) \
  (C1 ? (CS_CMM_MCDC_CX(n+0) 1) : \
    (C2 ? (CS_CMM_MCDC_CX(n+1) 1) : (CS_CMM_MCDC_CX(n+2) 0)))
#else /* !CODESCROLL_MCDC_EVALUATION && !CODESCROLL_MEM_ENABLE */
#define CS_MCDC_325_7(cs_cmm_C1, cs_cmm_C2, cs_cmm_n)  CS_MCDC_325_7_ORG
#endif /* CODESCROLL_MCDC_EVALUATION || CODESCROLL_MEM_ENABLE */
#if defined CODESCROLL_MCDC_EVALUATION || defined CODESCROLL_MEM_ENABLE
#define CS_MCDC_344_0(C1, C2, n) \
  (C1 ? \
    (C2 ? (CS_CMM_MCDC_CX(n+0) 1) : (CS_CMM_MCDC_CX(n+1) 0)) : (CS_CMM_MCDC_CX(n+2) 0))
#else /* !CODESCROLL_MCDC_EVALUATION && !CODESCROLL_MEM_ENABLE */
#define CS_MCDC_344_0(cs_cmm_C1, cs_cmm_C2, cs_cmm_n)  CS_MCDC_344_0_ORG
#endif /* CODESCROLL_MCDC_EVALUATION || CODESCROLL_MEM_ENABLE */
/* End of extern declarations of origins */

#define CS_MCDC_325_4_ORG	 (tmp > 5) && (tmp < 15)
#define CS_MCDC_325_7_ORG	 (i2sdiv < 2) || (i2sdiv > 0xFF)
#define CS_MCDC_344_0_ORG	 ((SPIx->SR & itpos) != (uint16_t)RESET) && enablestatus
