...
#endif
/* # 1 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\misc.c"*/
/* # 1 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\.coverage\\data//"*/
/* # 1 "<built-in>"*/
/* # 1 "<command-line>"*/
/* # 1 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\misc.c"*/
/* # 23 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\misc.c"*/
# 1 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\inc/misc.h" 1
/* # 31 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\inc/misc.h"*/
...
# 32 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\inc/misc.h" 2
...
# 24 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\misc.c" 2
/* # 95 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\misc.c"*/
void NVIC_PriorityGroupConfig(uint32_t NVIC_PriorityGroup)
{ CODESCROLL_FUNC_BEGIN(0, (0, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable0,0) 

  
  CS_CMM_PROBE_NODE_STMT(0,7,0) ((void)0);


  ((SCB_Type *) ((0xE000E000) + 0x0D00))->AIRCR = ((uint32_t)0x05FA0000) | NVIC_PriorityGroup;

CS_CMM_PROBE_NODE_STMT(0,6,1) 
 CODESCROLL_FUNC_END(0, 0, 102) } CODESCROLL_FUNC_END_RBRACE 
/* # 111 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\misc.c"*/
void NVIC_Init(NVIC_InitTypeDef* NVIC_InitStruct)
{ CODESCROLL_FUNC_BEGIN(1, (1, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable1,1) 
  CS_CMM_PROBE_NODE_DECL(CodeScrollVariable2,0,5,0)
  ...
  CS_CMM_PROBE_NODE_STMT(0,4,1) if (NVIC_InitStruct->NVIC_IRQChannelCmd != DISABLE)
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable3,2) 

    
    CS_CMM_PROBE_NODE_STMT(0,3,2) tmppriority = (0x700 - ((((SCB_Type *) ((0xE000E000) + 0x0D00))->AIRCR) & (uint32_t)0x700))>> 0x08;
  ...
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable4,3) 

    
    CS_CMM_PROBE_NODE_STMT(0,2,3) ((NVIC_Type *) ((0xE000E000) + 0x0100))->ICER[NVIC_InitStruct->NVIC_IRQChannel >> 0x05] =
      (uint32_t)0x01 << (NVIC_InitStruct->NVIC_IRQChannel & (uint8_t)0x1F);
  }

CS_CMM_PROBE_NODE_STMT(0,1,4) 
 CODESCROLL_FUNC_END(1, 0, 143) } CODESCROLL_FUNC_END_RBRACE 
/* # 154 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\misc.c"*/
void NVIC_SetVectorTable(uint32_t NVIC_VectTab, uint32_t Offset)
{ CODESCROLL_FUNC_BEGIN(2, (2, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable5,4) 

  
  CS_CMM_PROBE_NODE_STMT(0,0,0) ((void)0);
  ((void)0);

  ((SCB_Type *) ((0xE000E000) + 0x0D00))->VTOR = NVIC_VectTab | (Offset & (uint32_t)0x1FFFFF80);

CS_CMM_PROBE_NODE_STMT(1,7,1) 
 CODESCROLL_FUNC_END(2, 0, 161) } CODESCROLL_FUNC_END_RBRACE 
/* # 173 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\misc.c"*/
void NVIC_SystemLPConfig(uint8_t LowPowerMode, FunctionalState NewState)
{ CODESCROLL_FUNC_BEGIN(3, (3, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable6,5) 

  
  CS_CMM_PROBE_NODE_STMT(1,6,0) ((void)0);
  ((void)0);

  
  CS_CMM_PROBE_NODE_STMT(1,5,1) if (NewState != DISABLE)
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable7,6) 
    
    CS_CMM_PROBE_NODE_STMT(1,4,2) ((SCB_Type *) ((0xE000E000) + 0x0D00))->SCR |= LowPowerMode;
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable8,7) 
    
    CS_CMM_PROBE_NODE_STMT(1,3,3) ((SCB_Type *) ((0xE000E000) + 0x0D00))->SCR &= (uint32_t)(~(uint32_t)LowPowerMode);
  }

CS_CMM_PROBE_NODE_STMT(1,2,4) 
 CODESCROLL_FUNC_END(3, 0, 187) } CODESCROLL_FUNC_END_RBRACE 
/* # 197 "C:\\Users\\irrenhaus\\Atollic\\TrueSTUDIO\\STM32_workspace\\Bordcomputer\\firmware\\STM32F10x_StdPeriph_Driver\\src\\misc.c"*/
void SysTick_CLKSourceConfig(uint32_t SysTick_CLKSource)
{ CODESCROLL_FUNC_BEGIN(4, (4, CODESCROLL_BASIS_ADDR, 0)) CODESCROLL_FUNC_END_LBRACE  CS_CMM_PROBE_DECL_C1(CodeScrollVariable9,8) 

  
  CS_CMM_PROBE_NODE_STMT(1,1,0) ((void)0);
  
  CS_CMM_PROBE_NODE_STMT(1,0,1) if (SysTick_CLKSource == ((uint32_t)0x00000004))
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable10,9) 
    
    CS_CMM_PROBE_NODE_STMT(2,7,2) ((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL |= ((uint32_t)0x00000004);
  }
  else
  { CS_CMM_PROBE_DECL_C1(CodeScrollVariable11,10) 
    
    CS_CMM_PROBE_NODE_STMT(2,6,3) ((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL &= ((uint32_t)0xFFFFFFFB);
  }

CS_CMM_PROBE_NODE_STMT(2,5,4) 
 CODESCROLL_FUNC_END(4, 0, 209) } CODESCROLL_FUNC_END_RBRACE 
