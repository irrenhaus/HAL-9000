...
uint8_t CAN_Init(CAN_TypeDef* CANx, CAN_InitTypeDef* CAN_InitStruct)
{
  ...
  while (((CANx->MSR & ((uint32_t)0x00000001)) != ((uint32_t)0x00000001)) && (wait_ack != ((uint32_t)0x0000FFFF)))
  {
    wait_ack++;
  }


  if ((CANx->MSR & ((uint32_t)0x00000001)) != ((uint32_t)0x00000001))
  {
...
void CAN_FIFORelease(CAN_TypeDef* CANx, uint8_t FIFONumber)
{
  ...
  {
    CANx->RF0R = ((uint32_t)0x00000020);
  }

  else
  {
    CANx->RF1R = ((uint32_t)0x00000020);
  }
}
...
ITStatus CAN_GetITStatus(CAN_TypeDef* CANx, uint32_t CAN_IT)
{
  ...
  switch (CAN_IT)
  {
    case ((uint32_t)0x00000005):
      pendingbitstatus = CheckITStatus(CANx->TSR, ((uint32_t)0x00000001));
      break;
    case ((uint32_t)0x00000006):
      pendingbitstatus = CheckITStatus(CANx->TSR, ((uint32_t)0x00000100));
      break;
    case ((uint32_t)0x00000007):
      pendingbitstatus = CheckITStatus(CANx->TSR, ((uint32_t)0x00010000));
      break;
    case ((uint32_t)0x00000004):
      pendingbitstatus = CheckITStatus(CANx->RF0R, ((uint32_t)0x00000008));
      break;
    case ((uint32_t)0x00000008):
      pendingbitstatus = CheckITStatus(CANx->RF0R, ((uint32_t)0x00000010));
      break;
    case ((uint32_t)0x00000020):
      pendingbitstatus = CheckITStatus(CANx->RF1R, ((uint32_t)0x00000008));
      break;
    case ((uint32_t)0x00000040):
      pendingbitstatus = CheckITStatus(CANx->RF1R, ((uint32_t)0x00000010));
      break;
    case ((uint32_t)0x00000100):
      pendingbitstatus = CheckITStatus(CANx->ESR, ((uint32_t)0x00000001));
      break;
    case ((uint32_t)0x00000200):
      pendingbitstatus = CheckITStatus(CANx->ESR, ((uint32_t)0x00000002));
      break;
    case ((uint32_t)0x00000400):
      pendingbitstatus = CheckITStatus(CANx->ESR, ((uint32_t)0x00000004));
      break;
    case ((uint32_t)0x00020000):
      pendingbitstatus = CheckITStatus(CANx->MSR, ((uint32_t)0x00000010));
      break;
    case ((uint32_t)0x00010000):
      pendingbitstatus = CheckITStatus(CANx->MSR, ((uint32_t)0x00000008));
      break;
    default :
...
void CAN_ClearITPendingBit(CAN_TypeDef* CANx, uint32_t CAN_IT)
{
  ...
  {
    case ((uint32_t)0x00000005):
      CANx->TSR = ((uint32_t)0x00000001);
      break;
    case ((uint32_t)0x00000006):
      CANx->TSR = ((uint32_t)0x00000100);
      break;
    case ((uint32_t)0x00000007):
      CANx->TSR = ((uint32_t)0x00010000);
      break;
    case ((uint32_t)0x00000004):
      CANx->RF0R = ((uint32_t)0x00000008);
      break;
    case ((uint32_t)0x00000008):
      CANx->RF0R = ((uint32_t)0x00000010);
      break;
    case ((uint32_t)0x00000020):
      CANx->RF1R = ((uint32_t)0x00000008);
      break;
    case ((uint32_t)0x00000040):
      CANx->RF1R = ((uint32_t)0x00000010);
      break;
    case ((uint32_t)0x00000100):
      CANx->ESR &= ~ ((uint32_t)0x00000001);
      break;
    case ((uint32_t)0x00000200):
      CANx->ESR &= ~ ((uint32_t)0x00000002);
      break;
    case ((uint32_t)0x00000400):
      CANx->ESR &= ~ ((uint32_t)0x00000004);
      break;
    case ((uint32_t)0x00010000):
      CANx->MSR = ((uint32_t)0x00000008);
      break;
    case ((uint32_t)0x00020000):
      CANx->MSR = ((uint32_t)0x00000010);
      break;
    default :
      break;
  }
